...
class Kinematics
{
  public:
    ...
    void setInitialPartonMomentum(double kix, double kiy, double kiz, double kie);
    void setInitialPartonMomentum();
    void setFinalPartonMomentum(double kfx, double kfy, double kfz, double kfe);

    void Calculateyh();
    
    //Affinity Vectors
    TLorentzVector kiLab, kfLab, kiGamma, kfGamma, k;
